...
public class FloorStairBlock extends Block implements Waterloggable {
    public static final MapCodec<FloorStairBlock> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(BlockState.CODEC.fieldOf("base_state").forGetter(block -> block.baseBlockState), createSettingsCodec())
                    .apply(instance, FloorStairBlock::new)
    );
    ...
    @Override
    public MapCodec<? extends FloorStairBlock> getCodec() {
        return CODEC;
    }

    public FloorStairBlock(BlockState baseBlockState, AbstractBlock.Settings settings) {
        super(settings);
